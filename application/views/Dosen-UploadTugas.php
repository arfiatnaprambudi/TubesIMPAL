                ...
                <div class="col-md-9">
                    ...
                    <div class="tabbable paper-shadow relative" data-z="0.5">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="website-instructor-course-edit-task.html"><i class="fa fa-fw fa-credit-card"></i> <span class="hidden-sm hidden-xs">Task</span></a></li>
                        </ul>
                        <!-- // END Tabs -->
                        <!-- Panes -->
                        <div class="tab-content">
                            <div id="lessons" class="tab-pane active">
                                <div class="media v-middle s-container">
									...
									<form action='tugassimpan.php' method="post" enctype="multipart/form-data" >
										<table align="center">
											<tr>
												<td>Task</td>
												<td>:</td>
												<td><input type="file" name="soal_tugas" id="soal_tugas" class="btn btn-primary paper-shadow relative"></td>
											</tr>
											<tr>
