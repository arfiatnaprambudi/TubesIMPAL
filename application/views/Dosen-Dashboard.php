    ...
    <div class="container">
        ...
        <h1>Desain Analisis Algoritma</h1>
        <br>
            <div class="row">
                <div class="col-md-9">
                    <div class="row" data-toggle="isotope">
                        ...
                        <div class="item col-xs-12 col-lg-6">
                            <div class="panel panel-default paper-shadow" data-z="0.5">
                                ...
                                <div class="panel-footer text-right">
                                    ...
                                    <a href="<?php echo base_url();?>index.php/UploadMateri" class="btn btn-primary paper-shadow relative" data-z="0" data-hover-z="1" data-animated>UPLOAD MATERI  <i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item col-xs-12 col-lg-6">
                            <div class="panel panel-default paper-shadow" data-z="0.5">
                                ...
                                <div class="panel-footer text-right">
                                    <a href="<?php echo base_url();?>index.php/DaftarQuizDosen" class="btn btn-white paper-shadow relative" data-z="0" data-hover-z="1" data-animated>Lihat Semua quiz</a>
                                    <a href="<?php echo base_url();?>index.php/BuatQuizDosen" class="btn btn-primary paper-shadow relative" data-z="0" data-hover-z="1" data-animated>BUAT QUIZ  <i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
                        ...
                        <div class="panel-body list-group">
                            <ul class="list-group list-group-menu">
                                <li class="list-group-item active"><a class="link-text-color" href="<?php echo base_url();?>index.php/Welcome">Dashboard</a></li>
