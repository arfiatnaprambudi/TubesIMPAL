...
<html class="transition-navbar-scroll top-navbar-xlarge bottom-footer app-desktop app-mobile" lang="en">
<head>
    <meta charset="utf-8">
...
<body>
                    ...
                    <ul class="nav navbar-nav navbar-nav-bordered navbar-nav-margin-right">
                        ...
                        <li class="dropdown user">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="images/people/110/guy-1.jpg" alt="" class="img-circle" /> Mahasiswa
                            </a>
                            
                        </li>
                        <!-- // END user -->
                    </ul>
                    <a href="login.php" class="navbar-btn btn btn-primary">Logout</a>
                </div>
            </div>
            <!-- /.navbar-collapse -->
        </div>
                    ...
                    <div class="cell">
                        <div class="media width-120 v-middle margin-none">
                            ...
                            <div class="media-body">
                                <p class="text-body-2 text-light margin-none">Total Questions</p>
                                <p class="text-title text-primary margin-none">4</p>
                            </div>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="media width-120 v-middle margin-none">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-title text-success margin-none">40</p>
                            </div>
							
							<a href="proses_quiz.php">Kembali ke soal 1</a>
    ...
    <form action="" method="POST">
        ...
        ?>
            ...
            <input type="radio" name="option" value="a" required/> <?php echo $jawaban[0]; ?></br>
            <input type="radio" name="option" value="b" required/> <?php echo $jawaban[1]; ?></br>
            <input type="radio" name="option" value="c" required/> <?php echo $jawaban[2]; ?></br>
            <input type="radio" name="option" value="d" required/> <?php echo $jawaban[3]; ?></br>
    ...
    <!-- Footer -->
    <footer class="footer">
        <strong>Learning</strong> Tebes &copy; Copyright 2016
    </footer>
    <!-- // Footer -->
