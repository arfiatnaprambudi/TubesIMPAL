  ...
  c4.857-0.796,10.591,1.859,10.591,1.859l0.757-3.843L89.645,42.239z" />
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="website-directory-list.html">Upload Materi</a></li>
            </ul>
          </li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="website-student-courses.html">Upload Tugas</a></li>
            </ul>
          </li>
          <li class="dropdown">
                    ...
                    <ul class="nav navbar-nav navbar-nav-bordered navbar-nav-margin-right">
                        ...
                        <li class="dropdown user">
                            <a href="<?php echo base_url();?>index.php/ProfileDosen" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url();?>assets/images/people/110/guy-6.jpg" alt="" class="img-circle" /> Dosen
                            </a>
                            
                        </li>
                        <!-- // END user -->
                    </ul>
                    <a href="<?php echo base_url();?>index.php/Login" class="navbar-btn btn btn-primary">Logout</a>
                </div>
            </div>
            <!-- /.navbar-collapse -->
        </div>
        ...
        <div class="container parallax-layer" data-opacity="true">
            <div class="media v-middle">
                ...
                <div class="media-body">
                    <h1 class="text-white text-display-1 margin-v-0">Dosen</h1>
                    
                </div>
                <div class="media-right">
                    <span class="label bg-blue-500">Anda Login Sebagai Dosen</span>
                </div>
            </div>
        </div>
    </div>
