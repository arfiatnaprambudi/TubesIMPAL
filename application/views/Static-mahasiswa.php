...
This variant is to be used when loading the separate styling modules -->
    ...
    <link href="<?php echo base_url();?>assets/css/module-sidebar.min." rel="stylesheet" />
	...
	c4.857-0.796,10.591,1.859,10.591,1.859l0.757-3.843L89.645,42.239z" />
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="website-directory-grid.html">Daftar Materi</a></li>
              <li><a href="website-directory-list.html">Download Materi</a></li>
            </ul>
          </li>
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Tugas <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="website-student-dashboard.html">Daftar Tugas</a></li>
              <li><a href="website-student-courses.html">Download Tugas</a></li>
            </ul>
          </li>
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Quiz <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="website-student-dashboard.html">Daftar Quiz</a></li>
              <li><a href="website-student-courses.html">Upload Quiz</a></li>
              <li><a href="website-student-dashboard.html">Hasil Quiz</a></li>
            </ul>
          </li>
          <li class="dropdown">
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav navbar-nav-bordered navbar-nav-margin-right">
                        ...
                        <li class="dropdown user active">
                            <a href="<?php echo base_url();?>index.php/ProfileMahasiswa" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url();?>assets/images/people/110/guy-1.jpg" alt="" class="img-circle" /> Mahasiswa
                            </a>
                            
                        </li>
                        <!-- // END user -->
                    </ul>
                    <a href="<?php echo base_url();?>index.php/HomeMahasiswa/Logout" class="navbar-btn btn btn-primary">Logout</a>
                </div>
            </div>
            <!-- /.navbar-collapse -->
        </div>
        ...
        <div class="container parallax-layer" data-opacity="true">
            <div class="media v-middle">
                ...
                <div class="media-body">
                    <h1 class="text-white text-display-1 margin-v-0">Mahasiswa</h1>
